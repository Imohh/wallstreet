        ...
        <div className="flex flex-col-reverse md:flex-row space-y-3 md:space-y-0 md:space-x-10">
          <div className="md:max-h-screen md:w-1/2 flex flex-col md:flex-row items-end justify-between md:sticky md:top-0">
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -50 }}
            >
              <h1 className="product-name font-serif font-medium italic text-2xl md:text-4xl lg:text-5xl">
                {product.name}
              </h1>
              ...
              <div className="flex items-center justify-between pt-3">
                <div className="flex items-center">
                  <div className="pr-2">
                    <p className="product-price text-lg md:text-xl lg:text-2xl font-sans">
              ...
              <div
                className="product-description pt-5 md:pt-8 lg:pt-10 md:leading-relaxed lg:leading-loose lg:text-lg"
